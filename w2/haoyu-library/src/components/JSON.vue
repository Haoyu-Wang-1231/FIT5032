  ...
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <div>
        ...
        <ul>
          <li v-for="(store, name, key) in bookstores?.storeTypes" :key="key">
            {{ name }}: {{ store }}
          </li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul>
          <li v-for="(openHour, name, key) in bookstores?.openingHours" :key="key">
            {{ name }}: open time: {{ openHour.open }}, close time: {{ openHour.close }}
          </li>
        </ul>
    ...
    <section class="lab-section">
      ...
      <ul>
        <li v-for="author in authors" 
          :style="author.name === 'George Orwell' ? { fontWeight: 'bold', color: 'blue' } : {}" 
          :class="{highlight: author.name === 'George Orwell'}" :key="author.id">
            {{ author.name }}
        </li>
      </ul>
